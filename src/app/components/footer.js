        ...
        <div className="footer-container">
            ...
            <footer id="section-footer" className="page-section">
                ...
                <section id="footer-top" className="flex-container hide-mobile">
                    ...
                    <a rel="noreferrer noopener" target="_blank" href="https://github.com/ShadowMonster99/millennium-steam-patcher/" className="footer-column-item">
                        <span>GitHub</span>
                    </a>
                    </div>
                    <div className="footer-column">
                    ...
                    <a href="https://millennium.gitbook.io/steam-patcher" className="footer-column-item">
                        <span>Developers</span>
                    </a>
                    </div>
                    <div className="footer-column">
                    <h3 className="footer-column-header">Help</h3>
                    <a href="https://millennium.gitbook.io/steam-patcher" target="_blank" className="footer-column-item">Documentation</a>
                    </div>
                </section>
                <section id="footer-bottom" className="flex-container wrap align-center justify-between">
                    ...
                    <div className="footer-privacy text-center">
                        <a href="https://github.com/ShadowMonster99/millennium-steam-patcher/" className="footer-privacy-item">GitHub</a>
                        <a href="/discord" className="footer-privacy-item">Discord</a>
                        <a href="https://millennium.gitbook.io/steam-patcher" className="footer-privacy-item">Documentation</a>
                    </div>
                    </div>
                    <div className="flex-container wrap" id="footer-copyright-container">
                    <div className="footer-copyright text-center"> © 2020-{new Date().getFullYear()} <a className="anchor" rel="noreferrer noopener" target="_blank" href="https://github.com/ShadowMonster99">
                    ...
                    <a rel="noreferrer noopener" target="_blank" href="https://github.com/ShadowMonster99/millennium-steam-patcher/" className="social-icon github">
