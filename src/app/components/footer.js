        ...
        <div className="footer-container">
            <footer id="section-footer" className="page-section">
                ...
                <section id="footer-bottom" className="flex-container wrap align-center justify-between">
                    ...
                    <div className="footer-copyright text-center"> © {new Date().getFullYear()} <a className="anchor1" rel="noreferrer noopener" target="_blank" href="https://github.com/orgs/SteamClientHomebrew/people">
